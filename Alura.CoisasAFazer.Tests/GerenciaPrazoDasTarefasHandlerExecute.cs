    ...
    public class GerenciaPrazoDasTarefasHandlerExecute
    {
        ...
        public void QuandoTarefasEstiveremAtrasadasDeveMudarSeuStatus()
        {
            ...
            var tarefas = new List<Tarefa>
            {
                ...
                new Tarefa(8, "Comparecer à reunião", trabCateg, new DateTime(2018, 11, 12), null, StatusTarefa.Criada),
        ...
        [Fact]
        public void QuandoInvocadoDeveChamarAtualizarTarefasApenasQuantidadeDeVezesDoTotalDeTarefasAtrasadas()
        {
